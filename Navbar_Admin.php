...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
    ...
    <div class="collapse navbar-collapse" id="navbarNavDropdown">
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
          <a class="nav-link" href="/app/admin_center.php">Message Center</a>
        </li>
        <li class="nav-item">
            <a class="nav-link" href="delete_faculty.php">Delete Faculty</a>
          </li>
          <li class="nav-item">
              <!-- <a class="nav-link" href="#">Access Material</a>
            </li>
            <li class="nav-item">
